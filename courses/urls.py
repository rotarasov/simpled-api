...
urlpatterns = [
    ...
    path('<int:pk>/solutions/', views.SolutionListCreateAPIView.as_view(), name='solution-list'),
    path('<int:course_pk>/solutions/<int:solution_pk>', views.SolutionReadUpdateDeleteAPIVIew.as_view(),
